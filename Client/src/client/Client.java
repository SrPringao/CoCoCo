...
public class Client extends JFrame implements ActionListener {
    ...
    try {
        clientSocket = new Socket("192.168.100.6", 1234);
        
        // Crear objeto JSON
        JSONObject mensajeJson = new JSONObject();
        mensajeJson.put("idChat", idChat);
        mensajeJson.put("idUsr", idUsr);
        mensajeJson.put("mensaje", mensaje);
        mensajeJson.put("remitente", remitente.toString());
        // Convertir objeto JSON a cadena de texto JSON
        String mensajeCompleto = mensajeJson.toString();
