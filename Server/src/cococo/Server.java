...
public class Server {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ServerSocket server=new ServerSocket(1234); // 0 selecciona un puerto disponible al azar
...
class ClientThread extends Thread
{
    ...
    String Username;
    public static ArrayList<Socket> usuariosConectados=new ArrayList<Socket>();
